...
public class BdvSupplierExampleAdapter implements IClassRuntimeAdapter<IBdvSupplier, BdvSupplierExample> {
    @Override
    ...
    final public boolean useCustomAdapter() {
        return false; // Change to true if you want to use the custom serializer / deserializer below
    }
