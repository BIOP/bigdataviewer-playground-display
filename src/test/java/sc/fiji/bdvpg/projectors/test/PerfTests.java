...
/**
 * Performance tests for various bigdataviewer sc.fiji.bdvpg.projectors and
 * datasets Tests : Images: - 1 image - 2 images - 25 images Projector: -
 * default sum projector - a slow one (made slow on purpose) - one which ignores
 * all sources except one - one which ignores all sources and display black
 * Weirdly, the last two sc.fiji.bdvpg.projectors which are ignoring sources are
 * not much faster than those who display everything
 *
...
public class PerfTests {
	...
	/**
	 * Do you want to measure the perf ? Meaning rendering a few images offscreen
	...
	public static void main(final String... args) {
		...
		test(new TakeFirstProjectorFactory(), BdvSampleDatasets::twentyFiveImages); // Surprisingly
																																								// slow
																																								// :
																																								// the
																																								// projector
																																								...
																																								// it
																																								// projects
		test(new BlackProjectorFactory(), BdvSampleDatasets::twentyFiveImages); // Surprisingly
																																						// slow
																																						// :
																																						// the
																																						// projector
		...
		Function<BdvOptions, BdvHandle> dataprovider)
	{
		...
		if (testPerf) System.out.print(BdvProbeFPS.getStdMsPerFrame(bdvh) +
			" ms per frame");
