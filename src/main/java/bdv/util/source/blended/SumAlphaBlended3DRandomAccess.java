...
public class SumAlphaBlended3DRandomAccess<T extends NumericType<T>> implements SubSetBlendedRandomAccess<T> {
    ...
    public SumAlphaBlended3DRandomAccess(SumAlphaBlended3DRandomAccess<T> randomAccess) {
    ...
    public SumAlphaBlended3DRandomAccess(RandomAccess<T>[] ra_origins, RandomAccess<FloatType>[] ra_origins_alpha, Supplier<T> pixelSupplier) {
    ...
    public SumAlphaBlended3DRandomAccess(SumAlphaBlended3DRandomAccess<T> randomAccess, boolean[] subset) {
    ...
    @Override
    public SumAlphaBlended3DRandomAccess<T> copy() {
       return new SumAlphaBlended3DRandomAccess<T>(this);
    }

    @Override
    public RandomAccess<T> copy(boolean[] subset) {
        return new SumAlphaBlended3DRandomAccess<T>(this, subset);
    }
}
