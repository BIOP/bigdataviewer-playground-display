...
public class AverageAlphaBlended3DRandomAccess<T extends NumericType<T>> implements RandomAccess<T> {
    ...
    public AverageAlphaBlended3DRandomAccess(AverageAlphaBlended3DRandomAccess<T> randomAccess) {
    ...
    public AverageAlphaBlended3DRandomAccess(RandomAccess<T>[] ra_origins, RandomAccess<FloatType>[] ra_origins_alpha, Supplier<T> pixelSupplier) {
